...
weights_path = '/Users/anshub/Downloads/Image-Restoration-SRGAN--main/backend/generator_weights77.pth'
...
test_data_dir = "/Users/anshub/Downloads/Image-Restoration-SRGAN--main/backend/uploads"
...
for data_idx, data in enumerate(testloader):
    ...
    for i in range(batch_size):
        ...
        save_path = os.path.join('/Users/anshub/Downloads/Image-Restoration-SRGAN--main/backend/processed', "restored.jpg")
